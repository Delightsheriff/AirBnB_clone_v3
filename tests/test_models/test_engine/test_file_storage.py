...
class TestFileStorage(unittest.TestCase):
    ...
    @unittest.skipIf(models.storage_t == 'db', "not testing file storage")
    def test_get(self):
        """returns an object of a given class by id."""
        storage = models.storage
        obj = State(name='Albuquerque')
        obj.save()
    ...
    def test_count(self):
        """count returns the number of objects of a given class."""
        storage = models.storage
        ...
        State(name='Port Harcourt').save()
        self.assertGreater(storage.count(State), a)
        Amenity(name='Cable').save()
